 ...
 */
export const magentoCacheKeyFromType = (object: any) => {
  switch (object.__typename) {
    ...
    case MagentoGraphQLTypes.SelectedConfigurableOption:
      return object.value_id
        ? `${MagentoGraphQLTypes.SelectedConfigurableOption}:${object.value_id}`
        : undefined;
    ...
    case MagentoGraphQLTypes.ChiakiPage:
      return object.relative_url
        ? `${MagentoGraphQLTypes.ChiakiPage}:${object.relative_url}`
        : defaultDataIdFromObject(object);
    case MagentoGraphQLTypes.ProductBrand:
      return object.brand_id;
    case MagentoGraphQLTypes.StoreConfig:
      return object.id;
