...
const SearchField: React.FC<{
  ...
  const onSubmit = useCallback(() => {
    if (props.value) {
      ...
      props.setExpandedSuggest(false);
    }
  }, [props.value]);
  ...
  return (
    <div className="b-search w-full">
      <div className="form-search active relative w-full" id="search_mini_form">
        <form className="field search" onSubmit={handleSubmit(onSubmit)}>
          <input
            id="search"
            type="text"
        ...
        {/*<span className="search-cancel hidden">Cancel</span>*/}
      </div>
    </div>
  );
});
