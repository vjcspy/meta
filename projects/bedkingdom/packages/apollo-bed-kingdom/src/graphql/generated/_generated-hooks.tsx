...
export const BedCartDataFragmentDoc = gql`
    fragment BedCartData on Cart {
  id
  total_quantity
  ...
  shipping_addresses {
    ...
    `;
export const BedKingdomCustomerAddFragmentDoc = gql`
    fragment BedKingdomCustomerAdd on CustomerAddress {
  id
  firstname
  middlename
  lastname
  ...
  country_code
    ...
    `;
export const BedKingdomCustomerDetailFragmentDoc = gql`
    fragment BedKingdomCustomerDetail on Customer {
  id
  email
  firstname
  lastname
  ...
  addresses {
    ...
    `;
export const BedKingdomCustomerOrderFragmentDoc = gql`
  ...
  items {
    ...
    `;
export const BedKingdomCustomerOrderDetailsFragmentDoc = gql`
...
export const PriceRangeFragmentDoc = gql`
  ...
  maximum_price {
    ...
    `;
export const ConfigurableProductFragmentDoc = gql`
  ...
  ... on ConfigurableProduct {
    ...
    `;
export const BedKingdomProductDetailsFragmentDoc = gql`
    fragment BedKingdomProductDetails on ProductInterface {
  __typename
  id
  uid
  name
...
export const BedKingdomProductItemMostViewedFragmentDoc = gql`
...
export const MegaMenuItemFragmentDoc = gql`
    fragment MegaMenuItem on MegamenuItemsOutput {
  id
  item_id
  name
  path
  ...
  htmlId
    ...
    `;
export const TrustpilotBusinessReviewsResponseFragmentDoc = gql`
    fragment TrustpilotBusinessReviewsResponse on TrustpilotBusinessReviewsResponse {
  stars
  trust_score
  display_name
  number_of_reviews {
  ...
  reviews {
    ...
    `;
export const BedDataFragmentDoc = gql`
    fragment BedData on BedData {
  bed_category_product_image {
    url
    url_mobile
    label
  ...
  gtm_tag_click
    ...
    `;
export const ConfigurableProductListItemFragmentDoc = gql`
  ...
  ... on ConfigurableProduct {
    ...
    ${BedDataFragmentDoc}`;
export const BedKingdomProductItemFragmentDoc = gql`
...
export const BedKingdomWishlistItemFragmentDoc = gql`
    fragment BedKingdomWishlistItem on WishlistItemInterface {
  id
  quantity
  product {
    ...
    ${BedKingdomProductItemFragmentDoc}`;
export const AddAmGiftCardCodeToAccountDocument = gql`
    mutation addAmGiftCardCodeToAccount($amGiftcardCode: String!) {
  addAmGiftCardCodeToAccount(input: {am_giftcard_code: $amGiftcardCode}) {
    error
    message
  }
}
    `;
export type AddAmGiftCardCodeToAccountMutationFn = ApolloReactCommon.MutationFunction<AddAmGiftCardCodeToAccountMutation, AddAmGiftCardCodeToAccountMutationVariables>;

/**
 * __useAddAmGiftCardCodeToAccountMutation__
 *
 * To run a mutation, you first call `useAddAmGiftCardCodeToAccountMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddAmGiftCardCodeToAccountMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [addAmGiftCardCodeToAccountMutation, { data, loading, error }] = useAddAmGiftCardCodeToAccountMutation({
 *   variables: {
 *      amGiftcardCode: // value for 'amGiftcardCode'
 *   },
 * });
 */
export function useAddAmGiftCardCodeToAccountMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AddAmGiftCardCodeToAccountMutation, AddAmGiftCardCodeToAccountMutationVariables>) {
        return ApolloReactHooks.useMutation<AddAmGiftCardCodeToAccountMutation, AddAmGiftCardCodeToAccountMutationVariables>(AddAmGiftCardCodeToAccountDocument, baseOptions);
      }
export type AddAmGiftCardCodeToAccountMutationHookResult = ReturnType<typeof useAddAmGiftCardCodeToAccountMutation>;
export type AddAmGiftCardCodeToAccountMutationResult = ApolloReactCommon.MutationResult<AddAmGiftCardCodeToAccountMutation>;
export type AddAmGiftCardCodeToAccountMutationOptions = ApolloReactCommon.BaseMutationOptions<AddAmGiftCardCodeToAccountMutation, AddAmGiftCardCodeToAccountMutationVariables>;
export const AddBedProductQuestionDocument = gql`
    mutation addBedProductQuestion($input: ProductQuestionInput) {
  addProductQuestion(input: $input) {
    code
    message
  }
}
    `;
export type AddBedProductQuestionMutationFn = ApolloReactCommon.MutationFunction<AddBedProductQuestionMutation, AddBedProductQuestionMutationVariables>;

/**
 * __useAddBedProductQuestionMutation__
 *
 * To run a mutation, you first call `useAddBedProductQuestionMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddBedProductQuestionMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addBedProductQuestionMutation, { data, loading, error }] = useAddBedProductQuestionMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useAddBedProductQuestionMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AddBedProductQuestionMutation, AddBedProductQuestionMutationVariables>) {
        return ApolloReactHooks.useMutation<AddBedProductQuestionMutation, AddBedProductQuestionMutationVariables>(AddBedProductQuestionDocument, baseOptions);
      }
export type AddBedProductQuestionMutationHookResult = ReturnType<typeof useAddBedProductQuestionMutation>;
export type AddBedProductQuestionMutationResult = ApolloReactCommon.MutationResult<AddBedProductQuestionMutation>;
export type AddBedProductQuestionMutationOptions = ApolloReactCommon.BaseMutationOptions<AddBedProductQuestionMutation, AddBedProductQuestionMutationVariables>;
export const AddBedProductsToWishlistDocument = gql`
    mutation addBedProductsToWishlist($wishlistId: ID!, $wishlistItems: [WishlistItemInput!]!) {
  addProductsToWishlist(wishlistId: $wishlistId, wishlistItems: $wishlistItems) {
    ...
    ${BedKingdomWishlistItemFragmentDoc}`;
export type AddBedProductsToWishlistMutationFn = ApolloReactCommon.MutationFunction<AddBedProductsToWishlistMutation, AddBedProductsToWishlistMutationVariables>;

/**
 * __useAddBedProductsToWishlistMutation__
 *
 * To run a mutation, you first call `useAddBedProductsToWishlistMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddBedProductsToWishlistMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addBedProductsToWishlistMutation, { data, loading, error }] = useAddBedProductsToWishlistMutation({
 *   variables: {
 ...
 * });
 */
export function useAddBedProductsToWishlistMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AddBedProductsToWishlistMutation, AddBedProductsToWishlistMutationVariables>) {
        return ApolloReactHooks.useMutation<AddBedProductsToWishlistMutation, AddBedProductsToWishlistMutationVariables>(AddBedProductsToWishlistDocument, baseOptions);
      }
export type AddBedProductsToWishlistMutationHookResult = ReturnType<typeof useAddBedProductsToWishlistMutation>;
export type AddBedProductsToWishlistMutationResult = ApolloReactCommon.MutationResult<AddBedProductsToWishlistMutation>;
export type AddBedProductsToWishlistMutationOptions = ApolloReactCommon.BaseMutationOptions<AddBedProductsToWishlistMutation, AddBedProductsToWishlistMutationVariables>;
export const AmCustomFormSubmitDocument = gql`
  ...
  amCustomFormSubmit(input: {form_data: $form_data}) {
    ...
    `;
export type AmCustomFormSubmitMutationFn = ApolloReactCommon.MutationFunction<AmCustomFormSubmitMutation, AmCustomFormSubmitMutationVariables>;

/**
 * __useAmCustomFormSubmitMutation__
 *
 * To run a mutation, you first call `useAmCustomFormSubmitMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAmCustomFormSubmitMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [amCustomFormSubmitMutation, { data, loading, error }] = useAmCustomFormSubmitMutation({
 *   variables: {
 *      form_data: // value for 'form_data'
 *   },
 * });
 */
export function useAmCustomFormSubmitMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AmCustomFormSubmitMutation, AmCustomFormSubmitMutationVariables>) {
        return ApolloReactHooks.useMutation<AmCustomFormSubmitMutation, AmCustomFormSubmitMutationVariables>(AmCustomFormSubmitDocument, baseOptions);
      }
export type AmCustomFormSubmitMutationHookResult = ReturnType<typeof useAmCustomFormSubmitMutation>;
export type AmCustomFormSubmitMutationResult = ApolloReactCommon.MutationResult<AmCustomFormSubmitMutation>;
export type AmCustomFormSubmitMutationOptions = ApolloReactCommon.BaseMutationOptions<AmCustomFormSubmitMutation, AmCustomFormSubmitMutationVariables>;
export const ApplyAmGiftCardToCartDocument = gql`
  ...
  applyAmGiftCardToCart(input: $input) {
    ...
    ${BedCartDataFragmentDoc}`;
export type ApplyAmGiftCardToCartMutationFn = ApolloReactCommon.MutationFunction<ApplyAmGiftCardToCartMutation, ApplyAmGiftCardToCartMutationVariables>;

/**
 * __useApplyAmGiftCardToCartMutation__
 *
 * To run a mutation, you first call `useApplyAmGiftCardToCartMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useApplyAmGiftCardToCartMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [applyAmGiftCardToCartMutation, { data, loading, error }] = useApplyAmGiftCardToCartMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useApplyAmGiftCardToCartMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<ApplyAmGiftCardToCartMutation, ApplyAmGiftCardToCartMutationVariables>) {
        return ApolloReactHooks.useMutation<ApplyAmGiftCardToCartMutation, ApplyAmGiftCardToCartMutationVariables>(ApplyAmGiftCardToCartDocument, baseOptions);
      }
export type ApplyAmGiftCardToCartMutationHookResult = ReturnType<typeof useApplyAmGiftCardToCartMutation>;
export type ApplyAmGiftCardToCartMutationResult = ApolloReactCommon.MutationResult<ApplyAmGiftCardToCartMutation>;
export type ApplyAmGiftCardToCartMutationOptions = ApolloReactCommon.BaseMutationOptions<ApplyAmGiftCardToCartMutation, ApplyAmGiftCardToCartMutationVariables>;
export const ContactSubmitDocument = gql`
    mutation contactSubmit($form_data: String) {
  contactSubmit(input: {form_data: $form_data}) {
    code
    message
  }
}
    `;
export type ContactSubmitMutationFn = ApolloReactCommon.MutationFunction<ContactSubmitMutation, ContactSubmitMutationVariables>;

/**
 * __useContactSubmitMutation__
 *
 * To run a mutation, you first call `useContactSubmitMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useContactSubmitMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [contactSubmitMutation, { data, loading, error }] = useContactSubmitMutation({
 *   variables: {
 *      form_data: // value for 'form_data'
 *   },
 * });
 */
export function useContactSubmitMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<ContactSubmitMutation, ContactSubmitMutationVariables>) {
        return ApolloReactHooks.useMutation<ContactSubmitMutation, ContactSubmitMutationVariables>(ContactSubmitDocument, baseOptions);
      }
export type ContactSubmitMutationHookResult = ReturnType<typeof useContactSubmitMutation>;
export type ContactSubmitMutationResult = ApolloReactCommon.MutationResult<ContactSubmitMutation>;
export type ContactSubmitMutationOptions = ApolloReactCommon.BaseMutationOptions<ContactSubmitMutation, ContactSubmitMutationVariables>;
export const CreateBedKingdomCustomerAddressDocument = gql`
    mutation createBedKingdomCustomerAddress($input: CustomerAddressInput!) {
  createCustomerAddress(input: $input) {
    ...BedKingdomCustomerAdd
  }
}
    ${BedKingdomCustomerAddFragmentDoc}`;
export type CreateBedKingdomCustomerAddressMutationFn = ApolloReactCommon.MutationFunction<CreateBedKingdomCustomerAddressMutation, CreateBedKingdomCustomerAddressMutationVariables>;

/**
 * __useCreateBedKingdomCustomerAddressMutation__
 *
 * To run a mutation, you first call `useCreateBedKingdomCustomerAddressMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateBedKingdomCustomerAddressMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createBedKingdomCustomerAddressMutation, { data, loading, error }] = useCreateBedKingdomCustomerAddressMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateBedKingdomCustomerAddressMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateBedKingdomCustomerAddressMutation, CreateBedKingdomCustomerAddressMutationVariables>) {
        return ApolloReactHooks.useMutation<CreateBedKingdomCustomerAddressMutation, CreateBedKingdomCustomerAddressMutationVariables>(CreateBedKingdomCustomerAddressDocument, baseOptions);
      }
export type CreateBedKingdomCustomerAddressMutationHookResult = ReturnType<typeof useCreateBedKingdomCustomerAddressMutation>;
export type CreateBedKingdomCustomerAddressMutationResult = ApolloReactCommon.MutationResult<CreateBedKingdomCustomerAddressMutation>;
export type CreateBedKingdomCustomerAddressMutationOptions = ApolloReactCommon.BaseMutationOptions<CreateBedKingdomCustomerAddressMutation, CreateBedKingdomCustomerAddressMutationVariables>;
export const CreateCustomerV2Document = gql`
    mutation createCustomerV2($email: String!, $firstname: String!, $lastname: String!, $password: String!, $is_subscribed: Boolean!, $allow_remote_shopping_assistance: Boolean!) {
  createCustomerV2(
    input: {email: $email, firstname: $firstname, lastname: $lastname, password: $password, is_subscribed: $is_subscribed, allow_remote_shopping_assistance: $allow_remote_shopping_assistance}
  ) {
    customer {
      id
    }
    ...
    `;
export type CreateCustomerV2MutationFn = ApolloReactCommon.MutationFunction<CreateCustomerV2Mutation, CreateCustomerV2MutationVariables>;

/**
 * __useCreateCustomerV2Mutation__
 *
 * To run a mutation, you first call `useCreateCustomerV2Mutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateCustomerV2Mutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createCustomerV2Mutation, { data, loading, error }] = useCreateCustomerV2Mutation({
 *   variables: {
 ...
 *      allow_remote_shopping_assistance: // value for 'allow_remote_shopping_assistance'
 *   },
 * });
 */
export function useCreateCustomerV2Mutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateCustomerV2Mutation, CreateCustomerV2MutationVariables>) {
        return ApolloReactHooks.useMutation<CreateCustomerV2Mutation, CreateCustomerV2MutationVariables>(CreateCustomerV2Document, baseOptions);
      }
export type CreateCustomerV2MutationHookResult = ReturnType<typeof useCreateCustomerV2Mutation>;
export type CreateCustomerV2MutationResult = ApolloReactCommon.MutationResult<CreateCustomerV2Mutation>;
export type CreateCustomerV2MutationOptions = ApolloReactCommon.BaseMutationOptions<CreateCustomerV2Mutation, CreateCustomerV2MutationVariables>;
export const GdprAnonymisePerformDocument = gql`
    mutation gdprAnonymisePerform {
  gdprAnonymisePerform {
    error
    message
  }
}
    `;
export type GdprAnonymisePerformMutationFn = ApolloReactCommon.MutationFunction<GdprAnonymisePerformMutation, GdprAnonymisePerformMutationVariables>;

/**
 * __useGdprAnonymisePerformMutation__
 *
 * To run a mutation, you first call `useGdprAnonymisePerformMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useGdprAnonymisePerformMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [gdprAnonymisePerformMutation, { data, loading, error }] = useGdprAnonymisePerformMutation({
 *   variables: {
 *   },
 * });
 */
export function useGdprAnonymisePerformMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<GdprAnonymisePerformMutation, GdprAnonymisePerformMutationVariables>) {
        return ApolloReactHooks.useMutation<GdprAnonymisePerformMutation, GdprAnonymisePerformMutationVariables>(GdprAnonymisePerformDocument, baseOptions);
      }
export type GdprAnonymisePerformMutationHookResult = ReturnType<typeof useGdprAnonymisePerformMutation>;
export type GdprAnonymisePerformMutationResult = ApolloReactCommon.MutationResult<GdprAnonymisePerformMutation>;
export type GdprAnonymisePerformMutationOptions = ApolloReactCommon.BaseMutationOptions<GdprAnonymisePerformMutation, GdprAnonymisePerformMutationVariables>;
export const RemoveAmGiftCardCodeToAccountDocument = gql`
    mutation removeAmGiftCardCodeToAccount($amGiftcardCode: String!) {
  removeAmGiftCardCodeToAccount(input: {am_giftcard_code: $amGiftcardCode}) {
    error
    message
  }
}
    `;
export type RemoveAmGiftCardCodeToAccountMutationFn = ApolloReactCommon.MutationFunction<RemoveAmGiftCardCodeToAccountMutation, RemoveAmGiftCardCodeToAccountMutationVariables>;

/**
 * __useRemoveAmGiftCardCodeToAccountMutation__
 *
 * To run a mutation, you first call `useRemoveAmGiftCardCodeToAccountMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRemoveAmGiftCardCodeToAccountMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [removeAmGiftCardCodeToAccountMutation, { data, loading, error }] = useRemoveAmGiftCardCodeToAccountMutation({
 *   variables: {
 *      amGiftcardCode: // value for 'amGiftcardCode'
 *   },
 * });
 */
export function useRemoveAmGiftCardCodeToAccountMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<RemoveAmGiftCardCodeToAccountMutation, RemoveAmGiftCardCodeToAccountMutationVariables>) {
        return ApolloReactHooks.useMutation<RemoveAmGiftCardCodeToAccountMutation, RemoveAmGiftCardCodeToAccountMutationVariables>(RemoveAmGiftCardCodeToAccountDocument, baseOptions);
      }
export type RemoveAmGiftCardCodeToAccountMutationHookResult = ReturnType<typeof useRemoveAmGiftCardCodeToAccountMutation>;
export type RemoveAmGiftCardCodeToAccountMutationResult = ApolloReactCommon.MutationResult<RemoveAmGiftCardCodeToAccountMutation>;
export type RemoveAmGiftCardCodeToAccountMutationOptions = ApolloReactCommon.BaseMutationOptions<RemoveAmGiftCardCodeToAccountMutation, RemoveAmGiftCardCodeToAccountMutationVariables>;
export const RemoveAmGiftCardFromCartDocument = gql`
  ...
  removeAmGiftCardFromCart(input: $input) {
    ...
    ${BedCartDataFragmentDoc}`;
export type RemoveAmGiftCardFromCartMutationFn = ApolloReactCommon.MutationFunction<RemoveAmGiftCardFromCartMutation, RemoveAmGiftCardFromCartMutationVariables>;

/**
 * __useRemoveAmGiftCardFromCartMutation__
 *
 * To run a mutation, you first call `useRemoveAmGiftCardFromCartMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRemoveAmGiftCardFromCartMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [removeAmGiftCardFromCartMutation, { data, loading, error }] = useRemoveAmGiftCardFromCartMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useRemoveAmGiftCardFromCartMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<RemoveAmGiftCardFromCartMutation, RemoveAmGiftCardFromCartMutationVariables>) {
        return ApolloReactHooks.useMutation<RemoveAmGiftCardFromCartMutation, RemoveAmGiftCardFromCartMutationVariables>(RemoveAmGiftCardFromCartDocument, baseOptions);
      }
export type RemoveAmGiftCardFromCartMutationHookResult = ReturnType<typeof useRemoveAmGiftCardFromCartMutation>;
export type RemoveAmGiftCardFromCartMutationResult = ApolloReactCommon.MutationResult<RemoveAmGiftCardFromCartMutation>;
export type RemoveAmGiftCardFromCartMutationOptions = ApolloReactCommon.BaseMutationOptions<RemoveAmGiftCardFromCartMutation, RemoveAmGiftCardFromCartMutationVariables>;
export const RemoveItemsFromCartDocument = gql`
    mutation removeItemsFromCart($cartid: String!, $cartItems: [CartItemUpdateInput]!) {
  removeItemsFromCart(input: {cart_id: $cartid, cart_items: $cartItems}) {
    cart {
      id
      total_quantity
      items {
    ...
    `;
export type RemoveItemsFromCartMutationFn = ApolloReactCommon.MutationFunction<RemoveItemsFromCartMutation, RemoveItemsFromCartMutationVariables>;
 ...
 * });
 */
export function useRemoveItemsFromCartMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<RemoveItemsFromCartMutation, RemoveItemsFromCartMutationVariables>) {
        return ApolloReactHooks.useMutation<RemoveItemsFromCartMutation, RemoveItemsFromCartMutationVariables>(RemoveItemsFromCartDocument, baseOptions);
      }
export type RemoveItemsFromCartMutationHookResult = ReturnType<typeof useRemoveItemsFromCartMutation>;
export type RemoveItemsFromCartMutationResult = ApolloReactCommon.MutationResult<RemoveItemsFromCartMutation>;
export type RemoveItemsFromCartMutationOptions = ApolloReactCommon.BaseMutationOptions<RemoveItemsFromCartMutation, RemoveItemsFromCartMutationVariables>;
export const UpdateBedKingdomCustomerAddDocument = gql`
    mutation updateBedKingdomCustomerAdd($id: Int!, $input: CustomerAddressInput!) {
  updateCustomerAddress(id: $id, input: $input) {
    ...BedKingdomCustomerAdd
  }
}
    ${BedKingdomCustomerAddFragmentDoc}`;
export type UpdateBedKingdomCustomerAddMutationFn = ApolloReactCommon.MutationFunction<UpdateBedKingdomCustomerAddMutation, UpdateBedKingdomCustomerAddMutationVariables>;

/**
 * __useUpdateBedKingdomCustomerAddMutation__
 *
 * To run a mutation, you first call `useUpdateBedKingdomCustomerAddMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateBedKingdomCustomerAddMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateBedKingdomCustomerAddMutation, { data, loading, error }] = useUpdateBedKingdomCustomerAddMutation({
 *   variables: {
 *      id: // value for 'id'
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateBedKingdomCustomerAddMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateBedKingdomCustomerAddMutation, UpdateBedKingdomCustomerAddMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateBedKingdomCustomerAddMutation, UpdateBedKingdomCustomerAddMutationVariables>(UpdateBedKingdomCustomerAddDocument, baseOptions);
      }
export type UpdateBedKingdomCustomerAddMutationHookResult = ReturnType<typeof useUpdateBedKingdomCustomerAddMutation>;
export type UpdateBedKingdomCustomerAddMutationResult = ApolloReactCommon.MutationResult<UpdateBedKingdomCustomerAddMutation>;
export type UpdateBedKingdomCustomerAddMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateBedKingdomCustomerAddMutation, UpdateBedKingdomCustomerAddMutationVariables>;
export const UpdateBedKingdomCustomerDocument = gql`
    mutation updateBedKingdomCustomer($input: CustomerInput!) {
  updateCustomer(input: $input) {
    customer {
      ...BedKingdomCustomerDetail
    }
  }
}
    ${BedKingdomCustomerDetailFragmentDoc}`;
export type UpdateBedKingdomCustomerMutationFn = ApolloReactCommon.MutationFunction<UpdateBedKingdomCustomerMutation, UpdateBedKingdomCustomerMutationVariables>;

/**
 * __useUpdateBedKingdomCustomerMutation__
 *
 * To run a mutation, you first call `useUpdateBedKingdomCustomerMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateBedKingdomCustomerMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateBedKingdomCustomerMutation, { data, loading, error }] = useUpdateBedKingdomCustomerMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateBedKingdomCustomerMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateBedKingdomCustomerMutation, UpdateBedKingdomCustomerMutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateBedKingdomCustomerMutation, UpdateBedKingdomCustomerMutationVariables>(UpdateBedKingdomCustomerDocument, baseOptions);
      }
export type UpdateBedKingdomCustomerMutationHookResult = ReturnType<typeof useUpdateBedKingdomCustomerMutation>;
export type UpdateBedKingdomCustomerMutationResult = ApolloReactCommon.MutationResult<UpdateBedKingdomCustomerMutation>;
export type UpdateBedKingdomCustomerMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateBedKingdomCustomerMutation, UpdateBedKingdomCustomerMutationVariables>;
export const UpdateBedKingdomCustomerV2Document = gql`
    mutation updateBedKingdomCustomerV2($input: CustomerUpdateInput!) {
  updateCustomerV2(input: $input) {
    ...
    ${BedKingdomCustomerDetailFragmentDoc}`;
export type UpdateBedKingdomCustomerV2MutationFn = ApolloReactCommon.MutationFunction<UpdateBedKingdomCustomerV2Mutation, UpdateBedKingdomCustomerV2MutationVariables>;

/**
 * __useUpdateBedKingdomCustomerV2Mutation__
 *
 * To run a mutation, you first call `useUpdateBedKingdomCustomerV2Mutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateBedKingdomCustomerV2Mutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateBedKingdomCustomerV2Mutation, { data, loading, error }] = useUpdateBedKingdomCustomerV2Mutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateBedKingdomCustomerV2Mutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateBedKingdomCustomerV2Mutation, UpdateBedKingdomCustomerV2MutationVariables>) {
        return ApolloReactHooks.useMutation<UpdateBedKingdomCustomerV2Mutation, UpdateBedKingdomCustomerV2MutationVariables>(UpdateBedKingdomCustomerV2Document, baseOptions);
      }
export type UpdateBedKingdomCustomerV2MutationHookResult = ReturnType<typeof useUpdateBedKingdomCustomerV2Mutation>;
export type UpdateBedKingdomCustomerV2MutationResult = ApolloReactCommon.MutationResult<UpdateBedKingdomCustomerV2Mutation>;
export type UpdateBedKingdomCustomerV2MutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateBedKingdomCustomerV2Mutation, UpdateBedKingdomCustomerV2MutationVariables>;
export const AddXnotifStockDocument = gql`
    mutation addXnotifStock($input: XnotifInput) {
  xnotifStock(input: $input)
}
    `;
export type AddXnotifStockMutationFn = ApolloReactCommon.MutationFunction<AddXnotifStockMutation, AddXnotifStockMutationVariables>;

/**
 * __useAddXnotifStockMutation__
 *
 * To run a mutation, you first call `useAddXnotifStockMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddXnotifStockMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addXnotifStockMutation, { data, loading, error }] = useAddXnotifStockMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useAddXnotifStockMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AddXnotifStockMutation, AddXnotifStockMutationVariables>) {
        return ApolloReactHooks.useMutation<AddXnotifStockMutation, AddXnotifStockMutationVariables>(AddXnotifStockDocument, baseOptions);
      }
export type AddXnotifStockMutationHookResult = ReturnType<typeof useAddXnotifStockMutation>;
export type AddXnotifStockMutationResult = ApolloReactCommon.MutationResult<AddXnotifStockMutation>;
export type AddXnotifStockMutationOptions = ApolloReactCommon.BaseMutationOptions<AddXnotifStockMutation, AddXnotifStockMutationVariables>;
export const AmLabelProviderDocument = gql`
...
/**
 * __useAmLabelProviderQuery__
 *
 * To run a query within a React component, call `useAmLabelProviderQuery` and pass it any options that fit your needs.
 * When your component renders, `useAmLabelProviderQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAmLabelProviderQuery({
 *   variables: {
 *      productIds: // value for 'productIds'
 *   },
 * });
 */
export function useAmLabelProviderQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<AmLabelProviderQuery, AmLabelProviderQueryVariables>) {
        return ApolloReactHooks.useQuery<AmLabelProviderQuery, AmLabelProviderQueryVariables>(AmLabelProviderDocument, baseOptions);
      }
export function useAmLabelProviderLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<AmLabelProviderQuery, AmLabelProviderQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<AmLabelProviderQuery, AmLabelProviderQueryVariables>(AmLabelProviderDocument, baseOptions);
        }
export type AmLabelProviderQueryHookResult = ReturnType<typeof useAmLabelProviderQuery>;
export type AmLabelProviderLazyQueryHookResult = ReturnType<typeof useAmLabelProviderLazyQuery>;
export type AmLabelProviderQueryResult = ApolloReactCommon.QueryResult<AmLabelProviderQuery, AmLabelProviderQueryVariables>;
export const AmMostviewedGroupsDocument = gql`
    query amMostviewedGroups($id: String!) {
  amMostviewedGroups(uid: $id) {
    items {
      ...
      position
      items {
        ...BedKingdomProductItemMostViewed
      }
    }
  }
}
    ${BedKingdomProductItemMostViewedFragmentDoc}`;

/**
 * __useAmMostviewedGroupsQuery__
 *
 * To run a query within a React component, call `useAmMostviewedGroupsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAmMostviewedGroupsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAmMostviewedGroupsQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useAmMostviewedGroupsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<AmMostviewedGroupsQuery, AmMostviewedGroupsQueryVariables>) {
        return ApolloReactHooks.useQuery<AmMostviewedGroupsQuery, AmMostviewedGroupsQueryVariables>(AmMostviewedGroupsDocument, baseOptions);
      }
export function useAmMostviewedGroupsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<AmMostviewedGroupsQuery, AmMostviewedGroupsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<AmMostviewedGroupsQuery, AmMostviewedGroupsQueryVariables>(AmMostviewedGroupsDocument, baseOptions);
        }
export type AmMostviewedGroupsQueryHookResult = ReturnType<typeof useAmMostviewedGroupsQuery>;
export type AmMostviewedGroupsLazyQueryHookResult = ReturnType<typeof useAmMostviewedGroupsLazyQuery>;
export type AmMostviewedGroupsQueryResult = ApolloReactCommon.QueryResult<AmMostviewedGroupsQuery, AmMostviewedGroupsQueryVariables>;
export const AmUserGiftCardAccountDocument = gql`
...
/**
 * __useAmUserGiftCardAccountQuery__
 *
 * To run a query within a React component, call `useAmUserGiftCardAccountQuery` and pass it any options that fit your needs.
 * When your component renders, `useAmUserGiftCardAccountQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAmUserGiftCardAccountQuery({
 *   variables: {
 *   },
 * });
 */
export function useAmUserGiftCardAccountQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<AmUserGiftCardAccountQuery, AmUserGiftCardAccountQueryVariables>) {
        return ApolloReactHooks.useQuery<AmUserGiftCardAccountQuery, AmUserGiftCardAccountQueryVariables>(AmUserGiftCardAccountDocument, baseOptions);
      }
export function useAmUserGiftCardAccountLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<AmUserGiftCardAccountQuery, AmUserGiftCardAccountQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<AmUserGiftCardAccountQuery, AmUserGiftCardAccountQueryVariables>(AmUserGiftCardAccountDocument, baseOptions);
        }
export type AmUserGiftCardAccountQueryHookResult = ReturnType<typeof useAmUserGiftCardAccountQuery>;
export type AmUserGiftCardAccountLazyQueryHookResult = ReturnType<typeof useAmUserGiftCardAccountLazyQuery>;
export type AmUserGiftCardAccountQueryResult = ApolloReactCommon.QueryResult<AmUserGiftCardAccountQuery, AmUserGiftCardAccountQueryVariables>;
export const CalculateDeliveryNextDayDocument = gql`
    query calculateDeliveryNextDay($productId: Int!) {
  calculateDeliveryNextDay(productId: $productId) {
    limit_dates
    min_date
  }
}
...
/**
 * __useCalculateDeliveryNextDayQuery__
 *
 * To run a query within a React component, call `useCalculateDeliveryNextDayQuery` and pass it any options that fit your needs.
 * When your component renders, `useCalculateDeliveryNextDayQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCalculateDeliveryNextDayQuery({
 *   variables: {
 *      productId: // value for 'productId'
 *   },
 * });
 */
export function useCalculateDeliveryNextDayQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<CalculateDeliveryNextDayQuery, CalculateDeliveryNextDayQueryVariables>) {
        return ApolloReactHooks.useQuery<CalculateDeliveryNextDayQuery, CalculateDeliveryNextDayQueryVariables>(CalculateDeliveryNextDayDocument, baseOptions);
      }
export function useCalculateDeliveryNextDayLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CalculateDeliveryNextDayQuery, CalculateDeliveryNextDayQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<CalculateDeliveryNextDayQuery, CalculateDeliveryNextDayQueryVariables>(CalculateDeliveryNextDayDocument, baseOptions);
        }
export type CalculateDeliveryNextDayQueryHookResult = ReturnType<typeof useCalculateDeliveryNextDayQuery>;
export type CalculateDeliveryNextDayLazyQueryHookResult = ReturnType<typeof useCalculateDeliveryNextDayLazyQuery>;
export type CalculateDeliveryNextDayQueryResult = ApolloReactCommon.QueryResult<CalculateDeliveryNextDayQuery, CalculateDeliveryNextDayQueryVariables>;
export const CheckAmGiftCardAccountDocument = gql`
    query checkAmGiftCardAccount($input: AmGiftCardAccountInput!) {
  amGiftCardAccount(input: $input) {
    code
    expiration_date
    status
    current_balance {
...
/**
 * __useCheckAmGiftCardAccountQuery__
 *
 * To run a query within a React component, call `useCheckAmGiftCardAccountQuery` and pass it any options that fit your needs.
 * When your component renders, `useCheckAmGiftCardAccountQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCheckAmGiftCardAccountQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCheckAmGiftCardAccountQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<CheckAmGiftCardAccountQuery, CheckAmGiftCardAccountQueryVariables>) {
        return ApolloReactHooks.useQuery<CheckAmGiftCardAccountQuery, CheckAmGiftCardAccountQueryVariables>(CheckAmGiftCardAccountDocument, baseOptions);
      }
export function useCheckAmGiftCardAccountLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CheckAmGiftCardAccountQuery, CheckAmGiftCardAccountQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<CheckAmGiftCardAccountQuery, CheckAmGiftCardAccountQueryVariables>(CheckAmGiftCardAccountDocument, baseOptions);
        }
export type CheckAmGiftCardAccountQueryHookResult = ReturnType<typeof useCheckAmGiftCardAccountQuery>;
export type CheckAmGiftCardAccountLazyQueryHookResult = ReturnType<typeof useCheckAmGiftCardAccountLazyQuery>;
export type CheckAmGiftCardAccountQueryResult = ApolloReactCommon.QueryResult<CheckAmGiftCardAccountQuery, CheckAmGiftCardAccountQueryVariables>;
export const CustomAttributeMetadataDocument = gql`
...
/**
 * __useCustomAttributeMetadataQuery__
 *
 * To run a query within a React component, call `useCustomAttributeMetadataQuery` and pass it any options that fit your needs.
 * When your component renders, `useCustomAttributeMetadataQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCustomAttributeMetadataQuery({
 *   variables: {
 *      attributes: // value for 'attributes'
 *   },
 * });
 */
export function useCustomAttributeMetadataQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<CustomAttributeMetadataQuery, CustomAttributeMetadataQueryVariables>) {
        return ApolloReactHooks.useQuery<CustomAttributeMetadataQuery, CustomAttributeMetadataQueryVariables>(CustomAttributeMetadataDocument, baseOptions);
      }
export function useCustomAttributeMetadataLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CustomAttributeMetadataQuery, CustomAttributeMetadataQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<CustomAttributeMetadataQuery, CustomAttributeMetadataQueryVariables>(CustomAttributeMetadataDocument, baseOptions);
        }
export type CustomAttributeMetadataQueryHookResult = ReturnType<typeof useCustomAttributeMetadataQuery>;
export type CustomAttributeMetadataLazyQueryHookResult = ReturnType<typeof useCustomAttributeMetadataLazyQuery>;
export type CustomAttributeMetadataQueryResult = ApolloReactCommon.QueryResult<CustomAttributeMetadataQuery, CustomAttributeMetadataQueryVariables>;
export const CustomformDocument = gql`
...
/**
 * __useCustomformQuery__
 *
 * To run a query within a React component, call `useCustomformQuery` and pass it any options that fit your needs.
 * When your component renders, `useCustomformQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCustomformQuery({
 *   variables: {
 *      formId: // value for 'formId'
 *   },
 * });
 */
export function useCustomformQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<CustomformQuery, CustomformQueryVariables>) {
        return ApolloReactHooks.useQuery<CustomformQuery, CustomformQueryVariables>(CustomformDocument, baseOptions);
      }
export function useCustomformLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CustomformQuery, CustomformQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<CustomformQuery, CustomformQueryVariables>(CustomformDocument, baseOptions);
        }
export type CustomformQueryHookResult = ReturnType<typeof useCustomformQuery>;
export type CustomformLazyQueryHookResult = ReturnType<typeof useCustomformLazyQuery>;
export type CustomformQueryResult = ApolloReactCommon.QueryResult<CustomformQuery, CustomformQueryVariables>;
export const GetAmastyPageDocument = gql`
    query getAmastyPage($pageId: Int!) {
  amlanding(id: $pageId) {
    page_id
    title
    identifier
...
/**
 * __useGetAmastyPageQuery__
 *
 * To run a query within a React component, call `useGetAmastyPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAmastyPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAmastyPageQuery({
 *   variables: {
 *      pageId: // value for 'pageId'
 *   },
 * });
 */
export function useGetAmastyPageQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetAmastyPageQuery, GetAmastyPageQueryVariables>) {
        return ApolloReactHooks.useQuery<GetAmastyPageQuery, GetAmastyPageQueryVariables>(GetAmastyPageDocument, baseOptions);
      }
export function useGetAmastyPageLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetAmastyPageQuery, GetAmastyPageQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetAmastyPageQuery, GetAmastyPageQueryVariables>(GetAmastyPageDocument, baseOptions);
        }
export type GetAmastyPageQueryHookResult = ReturnType<typeof useGetAmastyPageQuery>;
export type GetAmastyPageLazyQueryHookResult = ReturnType<typeof useGetAmastyPageLazyQuery>;
export type GetAmastyPageQueryResult = ApolloReactCommon.QueryResult<GetAmastyPageQuery, GetAmastyPageQueryVariables>;
export const GetBedKingdomAutocompleteResultsDocument = gql`
...
/**
 * __useGetBedKingdomAutocompleteResultsQuery__
 *
 * To run a query within a React component, call `useGetBedKingdomAutocompleteResultsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedKingdomAutocompleteResultsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedKingdomAutocompleteResultsQuery({
 *   variables: {
 ...
 * });
 */
export function useGetBedKingdomAutocompleteResultsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedKingdomAutocompleteResultsQuery, GetBedKingdomAutocompleteResultsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedKingdomAutocompleteResultsQuery, GetBedKingdomAutocompleteResultsQueryVariables>(GetBedKingdomAutocompleteResultsDocument, baseOptions);
      }
export function useGetBedKingdomAutocompleteResultsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedKingdomAutocompleteResultsQuery, GetBedKingdomAutocompleteResultsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedKingdomAutocompleteResultsQuery, GetBedKingdomAutocompleteResultsQueryVariables>(GetBedKingdomAutocompleteResultsDocument, baseOptions);
        }
export type GetBedKingdomAutocompleteResultsQueryHookResult = ReturnType<typeof useGetBedKingdomAutocompleteResultsQuery>;
export type GetBedKingdomAutocompleteResultsLazyQueryHookResult = ReturnType<typeof useGetBedKingdomAutocompleteResultsLazyQuery>;
export type GetBedKingdomAutocompleteResultsQueryResult = ApolloReactCommon.QueryResult<GetBedKingdomAutocompleteResultsQuery, GetBedKingdomAutocompleteResultsQueryVariables>;
export const GetBedKingdomCatalogProductsDocument = gql`
...
/**
 * __useGetBedKingdomCatalogProductsQuery__
 *
 * To run a query within a React component, call `useGetBedKingdomCatalogProductsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedKingdomCatalogProductsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedKingdomCatalogProductsQuery({
 *   variables: {
 ...
 * });
 */
export function useGetBedKingdomCatalogProductsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedKingdomCatalogProductsQuery, GetBedKingdomCatalogProductsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedKingdomCatalogProductsQuery, GetBedKingdomCatalogProductsQueryVariables>(GetBedKingdomCatalogProductsDocument, baseOptions);
      }
export function useGetBedKingdomCatalogProductsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedKingdomCatalogProductsQuery, GetBedKingdomCatalogProductsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedKingdomCatalogProductsQuery, GetBedKingdomCatalogProductsQueryVariables>(GetBedKingdomCatalogProductsDocument, baseOptions);
        }
export type GetBedKingdomCatalogProductsQueryHookResult = ReturnType<typeof useGetBedKingdomCatalogProductsQuery>;
export type GetBedKingdomCatalogProductsLazyQueryHookResult = ReturnType<typeof useGetBedKingdomCatalogProductsLazyQuery>;
export type GetBedKingdomCatalogProductsQueryResult = ApolloReactCommon.QueryResult<GetBedKingdomCatalogProductsQuery, GetBedKingdomCatalogProductsQueryVariables>;
export const GetBedKingdomCategoryDetailForListingDocument = gql`
...
/**
 * __useGetBedKingdomCategoryDetailForListingQuery__
 *
 * To run a query within a React component, call `useGetBedKingdomCategoryDetailForListingQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedKingdomCategoryDetailForListingQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedKingdomCategoryDetailForListingQuery({
 *   variables: {
 *      category_id: // value for 'category_id'
 *   },
 * });
 */
export function useGetBedKingdomCategoryDetailForListingQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedKingdomCategoryDetailForListingQuery, GetBedKingdomCategoryDetailForListingQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedKingdomCategoryDetailForListingQuery, GetBedKingdomCategoryDetailForListingQueryVariables>(GetBedKingdomCategoryDetailForListingDocument, baseOptions);
      }
export function useGetBedKingdomCategoryDetailForListingLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedKingdomCategoryDetailForListingQuery, GetBedKingdomCategoryDetailForListingQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedKingdomCategoryDetailForListingQuery, GetBedKingdomCategoryDetailForListingQueryVariables>(GetBedKingdomCategoryDetailForListingDocument, baseOptions);
        }
export type GetBedKingdomCategoryDetailForListingQueryHookResult = ReturnType<typeof useGetBedKingdomCategoryDetailForListingQuery>;
export type GetBedKingdomCategoryDetailForListingLazyQueryHookResult = ReturnType<typeof useGetBedKingdomCategoryDetailForListingLazyQuery>;
export type GetBedKingdomCategoryDetailForListingQueryResult = ApolloReactCommon.QueryResult<GetBedKingdomCategoryDetailForListingQuery, GetBedKingdomCategoryDetailForListingQueryVariables>;
export const GetHomePageCategoriesDocument = gql`
  ...
  categories(filters: $filters) {
    items {
      ...
      name
      url_key
      products(pageSize: $pageSize, currentPage: $currentPage, sort: {position: ASC}) {
        items {
          ...BedKingdomProductItem
        }
      }
 ...
 * });
 */
export function useGetHomePageCategoriesQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetHomePageCategoriesQuery, GetHomePageCategoriesQueryVariables>) {
        return ApolloReactHooks.useQuery<GetHomePageCategoriesQuery, GetHomePageCategoriesQueryVariables>(GetHomePageCategoriesDocument, baseOptions);
      }
export function useGetHomePageCategoriesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetHomePageCategoriesQuery, GetHomePageCategoriesQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetHomePageCategoriesQuery, GetHomePageCategoriesQueryVariables>(GetHomePageCategoriesDocument, baseOptions);
        }
...
export type GetHomePageCategoriesQueryResult = ApolloReactCommon.QueryResult<GetHomePageCategoriesQuery, GetHomePageCategoriesQueryVariables>;
export const GetBedKingdomCustomerOrdersDocument = gql`
    query getBedKingdomCustomerOrders($pageSize: Int, $currentPage: Int, $filter: CustomerOrdersFilterInput) {
  customer {
    orders(pageSize: $pageSize, currentPage: $currentPage, filter: $filter) {
      items {
        ...BedKingdomCustomerOrder
      }
      total_count
      page_info {
        current_page
    ...
    ${BedKingdomCustomerOrderFragmentDoc}`;

/**
 * __useGetBedKingdomCustomerOrdersQuery__
 *
 * To run a query within a React component, call `useGetBedKingdomCustomerOrdersQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedKingdomCustomerOrdersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedKingdomCustomerOrdersQuery({
 *   variables: {
 *      pageSize: // value for 'pageSize'
 *      currentPage: // value for 'currentPage'
 *      filter: // value for 'filter'
 ...
 * });
 */
export function useGetBedKingdomCustomerOrdersQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedKingdomCustomerOrdersQuery, GetBedKingdomCustomerOrdersQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedKingdomCustomerOrdersQuery, GetBedKingdomCustomerOrdersQueryVariables>(GetBedKingdomCustomerOrdersDocument, baseOptions);
      }
export function useGetBedKingdomCustomerOrdersLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedKingdomCustomerOrdersQuery, GetBedKingdomCustomerOrdersQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedKingdomCustomerOrdersQuery, GetBedKingdomCustomerOrdersQueryVariables>(GetBedKingdomCustomerOrdersDocument, baseOptions);
        }
export type GetBedKingdomCustomerOrdersQueryHookResult = ReturnType<typeof useGetBedKingdomCustomerOrdersQuery>;
export type GetBedKingdomCustomerOrdersLazyQueryHookResult = ReturnType<typeof useGetBedKingdomCustomerOrdersLazyQuery>;
export type GetBedKingdomCustomerOrdersQueryResult = ApolloReactCommon.QueryResult<GetBedKingdomCustomerOrdersQuery, GetBedKingdomCustomerOrdersQueryVariables>;
export const GetBedKingdomCustomerOrdersDetailsDocument = gql`
    query getBedKingdomCustomerOrdersDetails($pageSize: Int, $currentPage: Int, $filter: CustomerOrdersFilterInput) {
  customer {
    orders(pageSize: $pageSize, currentPage: $currentPage, filter: $filter) {
      items {
    ...
    ${BedKingdomCustomerOrderDetailsFragmentDoc}`;

/**
 * __useGetBedKingdomCustomerOrdersDetailsQuery__
 *
 * To run a query within a React component, call `useGetBedKingdomCustomerOrdersDetailsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedKingdomCustomerOrdersDetailsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedKingdomCustomerOrdersDetailsQuery({
 *   variables: {
 *      pageSize: // value for 'pageSize'
 *      currentPage: // value for 'currentPage'
 *      filter: // value for 'filter'
 ...
 * });
 */
export function useGetBedKingdomCustomerOrdersDetailsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedKingdomCustomerOrdersDetailsQuery, GetBedKingdomCustomerOrdersDetailsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedKingdomCustomerOrdersDetailsQuery, GetBedKingdomCustomerOrdersDetailsQueryVariables>(GetBedKingdomCustomerOrdersDetailsDocument, baseOptions);
      }
export function useGetBedKingdomCustomerOrdersDetailsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedKingdomCustomerOrdersDetailsQuery, GetBedKingdomCustomerOrdersDetailsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedKingdomCustomerOrdersDetailsQuery, GetBedKingdomCustomerOrdersDetailsQueryVariables>(GetBedKingdomCustomerOrdersDetailsDocument, baseOptions);
        }
export type GetBedKingdomCustomerOrdersDetailsQueryHookResult = ReturnType<typeof useGetBedKingdomCustomerOrdersDetailsQuery>;
export type GetBedKingdomCustomerOrdersDetailsLazyQueryHookResult = ReturnType<typeof useGetBedKingdomCustomerOrdersDetailsLazyQuery>;
export type GetBedKingdomCustomerOrdersDetailsQueryResult = ApolloReactCommon.QueryResult<GetBedKingdomCustomerOrdersDetailsQuery, GetBedKingdomCustomerOrdersDetailsQueryVariables>;
export const GetBedKingdomHomeBannerDocument = gql`
    query getBedKingdomHomeBanner($sliderId: Int!) {
...
/**
 * __useGetBedKingdomHomeBannerQuery__
 *
 * To run a query within a React component, call `useGetBedKingdomHomeBannerQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedKingdomHomeBannerQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedKingdomHomeBannerQuery({
 *   variables: {
 *      sliderId: // value for 'sliderId'
 *   },
 * });
 */
export function useGetBedKingdomHomeBannerQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedKingdomHomeBannerQuery, GetBedKingdomHomeBannerQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedKingdomHomeBannerQuery, GetBedKingdomHomeBannerQueryVariables>(GetBedKingdomHomeBannerDocument, baseOptions);
      }
export function useGetBedKingdomHomeBannerLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedKingdomHomeBannerQuery, GetBedKingdomHomeBannerQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedKingdomHomeBannerQuery, GetBedKingdomHomeBannerQueryVariables>(GetBedKingdomHomeBannerDocument, baseOptions);
        }
export type GetBedKingdomHomeBannerQueryHookResult = ReturnType<typeof useGetBedKingdomHomeBannerQuery>;
export type GetBedKingdomHomeBannerLazyQueryHookResult = ReturnType<typeof useGetBedKingdomHomeBannerLazyQuery>;
export type GetBedKingdomHomeBannerQueryResult = ApolloReactCommon.QueryResult<GetBedKingdomHomeBannerQuery, GetBedKingdomHomeBannerQueryVariables>;
export const GetBedKingdomMegaMenuDocument = gql`
...
/**
 * __useGetBedKingdomMegaMenuQuery__
 *
 * To run a query within a React component, call `useGetBedKingdomMegaMenuQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedKingdomMegaMenuQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedKingdomMegaMenuQuery({
 *   variables: {
 *      menuId: // value for 'menuId'
 *   },
 * });
 */
export function useGetBedKingdomMegaMenuQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedKingdomMegaMenuQuery, GetBedKingdomMegaMenuQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedKingdomMegaMenuQuery, GetBedKingdomMegaMenuQueryVariables>(GetBedKingdomMegaMenuDocument, baseOptions);
      }
export function useGetBedKingdomMegaMenuLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedKingdomMegaMenuQuery, GetBedKingdomMegaMenuQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedKingdomMegaMenuQuery, GetBedKingdomMegaMenuQueryVariables>(GetBedKingdomMegaMenuDocument, baseOptions);
        }
export type GetBedKingdomMegaMenuQueryHookResult = ReturnType<typeof useGetBedKingdomMegaMenuQuery>;
export type GetBedKingdomMegaMenuLazyQueryHookResult = ReturnType<typeof useGetBedKingdomMegaMenuLazyQuery>;
export type GetBedKingdomMegaMenuQueryResult = ApolloReactCommon.QueryResult<GetBedKingdomMegaMenuQuery, GetBedKingdomMegaMenuQueryVariables>;
export const GetBedKingdomMegaMenuSsrDocument = gql`
    query getBedKingdomMegaMenuSSR($menuId: Int!) {
  getMenuItems(menuId: $menuId) {
    ...MegaMenuItem
  }
}
...
/**
 * __useGetBedKingdomMegaMenuSsrQuery__
 *
 * To run a query within a React component, call `useGetBedKingdomMegaMenuSsrQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedKingdomMegaMenuSsrQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedKingdomMegaMenuSsrQuery({
 *   variables: {
 *      menuId: // value for 'menuId'
 *   },
 * });
 */
export function useGetBedKingdomMegaMenuSsrQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedKingdomMegaMenuSsrQuery, GetBedKingdomMegaMenuSsrQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedKingdomMegaMenuSsrQuery, GetBedKingdomMegaMenuSsrQueryVariables>(GetBedKingdomMegaMenuSsrDocument, baseOptions);
      }
export function useGetBedKingdomMegaMenuSsrLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedKingdomMegaMenuSsrQuery, GetBedKingdomMegaMenuSsrQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedKingdomMegaMenuSsrQuery, GetBedKingdomMegaMenuSsrQueryVariables>(GetBedKingdomMegaMenuSsrDocument, baseOptions);
        }
export type GetBedKingdomMegaMenuSsrQueryHookResult = ReturnType<typeof useGetBedKingdomMegaMenuSsrQuery>;
export type GetBedKingdomMegaMenuSsrLazyQueryHookResult = ReturnType<typeof useGetBedKingdomMegaMenuSsrLazyQuery>;
export type GetBedKingdomMegaMenuSsrQueryResult = ApolloReactCommon.QueryResult<GetBedKingdomMegaMenuSsrQuery, GetBedKingdomMegaMenuSsrQueryVariables>;
export const GetBedProductAttachmentsDocument = gql`
    query getBedProductAttachments($productId: Int!) {
  getProductAttachments(productId: $productId) {
    icon_url
    frontend_url
    label
    file_size
...
/**
 * __useGetBedProductAttachmentsQuery__
 *
 * To run a query within a React component, call `useGetBedProductAttachmentsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedProductAttachmentsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedProductAttachmentsQuery({
 *   variables: {
 *      productId: // value for 'productId'
 *   },
 * });
 */
export function useGetBedProductAttachmentsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedProductAttachmentsQuery, GetBedProductAttachmentsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedProductAttachmentsQuery, GetBedProductAttachmentsQueryVariables>(GetBedProductAttachmentsDocument, baseOptions);
      }
export function useGetBedProductAttachmentsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedProductAttachmentsQuery, GetBedProductAttachmentsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedProductAttachmentsQuery, GetBedProductAttachmentsQueryVariables>(GetBedProductAttachmentsDocument, baseOptions);
        }
export type GetBedProductAttachmentsQueryHookResult = ReturnType<typeof useGetBedProductAttachmentsQuery>;
export type GetBedProductAttachmentsLazyQueryHookResult = ReturnType<typeof useGetBedProductAttachmentsLazyQuery>;
export type GetBedProductAttachmentsQueryResult = ApolloReactCommon.QueryResult<GetBedProductAttachmentsQuery, GetBedProductAttachmentsQueryVariables>;
export const GetBedProductMoreInformationDocument = gql`
    query getBedProductMoreInformation($productId: Int!) {
  getProductMoreInformation(productId: $productId) {
    label
    value
    code
  }
...
/**
 * __useGetBedProductMoreInformationQuery__
 *
 * To run a query within a React component, call `useGetBedProductMoreInformationQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedProductMoreInformationQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedProductMoreInformationQuery({
 *   variables: {
 *      productId: // value for 'productId'
 *   },
 * });
 */
export function useGetBedProductMoreInformationQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedProductMoreInformationQuery, GetBedProductMoreInformationQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedProductMoreInformationQuery, GetBedProductMoreInformationQueryVariables>(GetBedProductMoreInformationDocument, baseOptions);
      }
export function useGetBedProductMoreInformationLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedProductMoreInformationQuery, GetBedProductMoreInformationQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedProductMoreInformationQuery, GetBedProductMoreInformationQueryVariables>(GetBedProductMoreInformationDocument, baseOptions);
        }
export type GetBedProductMoreInformationQueryHookResult = ReturnType<typeof useGetBedProductMoreInformationQuery>;
export type GetBedProductMoreInformationLazyQueryHookResult = ReturnType<typeof useGetBedProductMoreInformationLazyQuery>;
export type GetBedProductMoreInformationQueryResult = ApolloReactCommon.QueryResult<GetBedProductMoreInformationQuery, GetBedProductMoreInformationQueryVariables>;
export const GetBedProductQuestionsDocument = gql`
...
/**
 * __useGetBedProductQuestionsQuery__
 *
 * To run a query within a React component, call `useGetBedProductQuestionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedProductQuestionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedProductQuestionsQuery({
 *   variables: {
 *      productId: // value for 'productId'
 *   },
 * });
 */
export function useGetBedProductQuestionsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedProductQuestionsQuery, GetBedProductQuestionsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedProductQuestionsQuery, GetBedProductQuestionsQueryVariables>(GetBedProductQuestionsDocument, baseOptions);
      }
export function useGetBedProductQuestionsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedProductQuestionsQuery, GetBedProductQuestionsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedProductQuestionsQuery, GetBedProductQuestionsQueryVariables>(GetBedProductQuestionsDocument, baseOptions);
        }
export type GetBedProductQuestionsQueryHookResult = ReturnType<typeof useGetBedProductQuestionsQuery>;
export type GetBedProductQuestionsLazyQueryHookResult = ReturnType<typeof useGetBedProductQuestionsLazyQuery>;
export type GetBedProductQuestionsQueryResult = ApolloReactCommon.QueryResult<GetBedProductQuestionsQuery, GetBedProductQuestionsQueryVariables>;
export const GetBedTrustpilotProductReviewsDetailDocument = gql`
...
/**
 * __useGetBedTrustpilotProductReviewsDetailQuery__
 *
 * To run a query within a React component, call `useGetBedTrustpilotProductReviewsDetailQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedTrustpilotProductReviewsDetailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedTrustpilotProductReviewsDetailQuery({
 *   variables: {
 *      productId: // value for 'productId'
 *      pageSize: // value for 'pageSize'
 *      currentPage: // value for 'currentPage'
 ...
 * });
 */
export function useGetBedTrustpilotProductReviewsDetailQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedTrustpilotProductReviewsDetailQuery, GetBedTrustpilotProductReviewsDetailQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedTrustpilotProductReviewsDetailQuery, GetBedTrustpilotProductReviewsDetailQueryVariables>(GetBedTrustpilotProductReviewsDetailDocument, baseOptions);
      }
export function useGetBedTrustpilotProductReviewsDetailLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedTrustpilotProductReviewsDetailQuery, GetBedTrustpilotProductReviewsDetailQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedTrustpilotProductReviewsDetailQuery, GetBedTrustpilotProductReviewsDetailQueryVariables>(GetBedTrustpilotProductReviewsDetailDocument, baseOptions);
        }
export type GetBedTrustpilotProductReviewsDetailQueryHookResult = ReturnType<typeof useGetBedTrustpilotProductReviewsDetailQuery>;
export type GetBedTrustpilotProductReviewsDetailLazyQueryHookResult = ReturnType<typeof useGetBedTrustpilotProductReviewsDetailLazyQuery>;
export type GetBedTrustpilotProductReviewsDetailQueryResult = ApolloReactCommon.QueryResult<GetBedTrustpilotProductReviewsDetailQuery, GetBedTrustpilotProductReviewsDetailQueryVariables>;
export const GetBedkingdomBrandListDocument = gql`
    query getBedkingdomBrandList {
  ambrandlist {
    items {
      brandId
      label
...
/**
 * __useGetBedkingdomBrandListQuery__
 *
 * To run a query within a React component, call `useGetBedkingdomBrandListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedkingdomBrandListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedkingdomBrandListQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetBedkingdomBrandListQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedkingdomBrandListQuery, GetBedkingdomBrandListQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedkingdomBrandListQuery, GetBedkingdomBrandListQueryVariables>(GetBedkingdomBrandListDocument, baseOptions);
      }
export function useGetBedkingdomBrandListLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedkingdomBrandListQuery, GetBedkingdomBrandListQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedkingdomBrandListQuery, GetBedkingdomBrandListQueryVariables>(GetBedkingdomBrandListDocument, baseOptions);
        }
export type GetBedkingdomBrandListQueryHookResult = ReturnType<typeof useGetBedkingdomBrandListQuery>;
export type GetBedkingdomBrandListLazyQueryHookResult = ReturnType<typeof useGetBedkingdomBrandListLazyQuery>;
export type GetBedkingdomBrandListQueryResult = ApolloReactCommon.QueryResult<GetBedkingdomBrandListQuery, GetBedkingdomBrandListQueryVariables>;
export const GetBedkingdomProductDetailByUrlKeyDocument = gql`
  ...
  products(filter: {url_key: {eq: $urlKey}}) {
    ...
    ${BedKingdomProductDetailsFragmentDoc}`;

/**
 * __useGetBedkingdomProductDetailByUrlKeyQuery__
 *
 * To run a query within a React component, call `useGetBedkingdomProductDetailByUrlKeyQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedkingdomProductDetailByUrlKeyQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedkingdomProductDetailByUrlKeyQuery({
 *   variables: {
 *      urlKey: // value for 'urlKey'
 *   },
 * });
 */
export function useGetBedkingdomProductDetailByUrlKeyQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedkingdomProductDetailByUrlKeyQuery, GetBedkingdomProductDetailByUrlKeyQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedkingdomProductDetailByUrlKeyQuery, GetBedkingdomProductDetailByUrlKeyQueryVariables>(GetBedkingdomProductDetailByUrlKeyDocument, baseOptions);
      }
export function useGetBedkingdomProductDetailByUrlKeyLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedkingdomProductDetailByUrlKeyQuery, GetBedkingdomProductDetailByUrlKeyQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedkingdomProductDetailByUrlKeyQuery, GetBedkingdomProductDetailByUrlKeyQueryVariables>(GetBedkingdomProductDetailByUrlKeyDocument, baseOptions);
        }
export type GetBedkingdomProductDetailByUrlKeyQueryHookResult = ReturnType<typeof useGetBedkingdomProductDetailByUrlKeyQuery>;
export type GetBedkingdomProductDetailByUrlKeyLazyQueryHookResult = ReturnType<typeof useGetBedkingdomProductDetailByUrlKeyLazyQuery>;
export type GetBedkingdomProductDetailByUrlKeyQueryResult = ApolloReactCommon.QueryResult<GetBedkingdomProductDetailByUrlKeyQuery, GetBedkingdomProductDetailByUrlKeyQueryVariables>;
export const GetBedkingdomStoreConfigDocument = gql`
    query getBedkingdomStoreConfig {
  storeConfig {
    default_title
    default_description
    default_keywords
...
/**
 * __useGetBedkingdomStoreConfigQuery__
 *
 * To run a query within a React component, call `useGetBedkingdomStoreConfigQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedkingdomStoreConfigQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedkingdomStoreConfigQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetBedkingdomStoreConfigQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedkingdomStoreConfigQuery, GetBedkingdomStoreConfigQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedkingdomStoreConfigQuery, GetBedkingdomStoreConfigQueryVariables>(GetBedkingdomStoreConfigDocument, baseOptions);
      }
export function useGetBedkingdomStoreConfigLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedkingdomStoreConfigQuery, GetBedkingdomStoreConfigQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedkingdomStoreConfigQuery, GetBedkingdomStoreConfigQueryVariables>(GetBedkingdomStoreConfigDocument, baseOptions);
        }
export type GetBedkingdomStoreConfigQueryHookResult = ReturnType<typeof useGetBedkingdomStoreConfigQuery>;
export type GetBedkingdomStoreConfigLazyQueryHookResult = ReturnType<typeof useGetBedkingdomStoreConfigLazyQuery>;
export type GetBedkingdomStoreConfigQueryResult = ApolloReactCommon.QueryResult<GetBedkingdomStoreConfigQuery, GetBedkingdomStoreConfigQueryVariables>;
export const GetBedkingdomWishlistDetailDocument = gql`
    query getBedkingdomWishlistDetail($pageSize: Int!, $currentPage: Int!) {
  customer {
    wishlists {
      id
      items_count
...
/**
 * __useGetBedkingdomWishlistDetailQuery__
 *
 * To run a query within a React component, call `useGetBedkingdomWishlistDetailQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBedkingdomWishlistDetailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBedkingdomWishlistDetailQuery({
 *   variables: {
 *      pageSize: // value for 'pageSize'
 *      currentPage: // value for 'currentPage'
 *   },
 * });
 */
export function useGetBedkingdomWishlistDetailQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetBedkingdomWishlistDetailQuery, GetBedkingdomWishlistDetailQueryVariables>) {
        return ApolloReactHooks.useQuery<GetBedkingdomWishlistDetailQuery, GetBedkingdomWishlistDetailQueryVariables>(GetBedkingdomWishlistDetailDocument, baseOptions);
      }
export function useGetBedkingdomWishlistDetailLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetBedkingdomWishlistDetailQuery, GetBedkingdomWishlistDetailQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetBedkingdomWishlistDetailQuery, GetBedkingdomWishlistDetailQueryVariables>(GetBedkingdomWishlistDetailDocument, baseOptions);
        }
export type GetBedkingdomWishlistDetailQueryHookResult = ReturnType<typeof useGetBedkingdomWishlistDetailQuery>;
export type GetBedkingdomWishlistDetailLazyQueryHookResult = ReturnType<typeof useGetBedkingdomWishlistDetailLazyQuery>;
export type GetBedkingdomWishlistDetailQueryResult = ApolloReactCommon.QueryResult<GetBedkingdomWishlistDetailQuery, GetBedkingdomWishlistDetailQueryVariables>;
export const GetRichSnippetsDocument = gql`
    query getRichSnippets {
  getRichSnippets
}
    `;

/**
 * __useGetRichSnippetsQuery__
 *
 * To run a query within a React component, call `useGetRichSnippetsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetRichSnippetsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetRichSnippetsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetRichSnippetsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetRichSnippetsQuery, GetRichSnippetsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetRichSnippetsQuery, GetRichSnippetsQueryVariables>(GetRichSnippetsDocument, baseOptions);
      }
export function useGetRichSnippetsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetRichSnippetsQuery, GetRichSnippetsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetRichSnippetsQuery, GetRichSnippetsQueryVariables>(GetRichSnippetsDocument, baseOptions);
        }
export type GetRichSnippetsQueryHookResult = ReturnType<typeof useGetRichSnippetsQuery>;
export type GetRichSnippetsLazyQueryHookResult = ReturnType<typeof useGetRichSnippetsLazyQuery>;
export type GetRichSnippetsQueryResult = ApolloReactCommon.QueryResult<GetRichSnippetsQuery, GetRichSnippetsQueryVariables>;
export const GetGoogleTagManagerDocument = gql`
...
/**
 * __useGetGoogleTagManagerQuery__
 *
 * To run a query within a React component, call `useGetGoogleTagManagerQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetGoogleTagManagerQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetGoogleTagManagerQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetGoogleTagManagerQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetGoogleTagManagerQuery, GetGoogleTagManagerQueryVariables>) {
        return ApolloReactHooks.useQuery<GetGoogleTagManagerQuery, GetGoogleTagManagerQueryVariables>(GetGoogleTagManagerDocument, baseOptions);
      }
export function useGetGoogleTagManagerLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetGoogleTagManagerQuery, GetGoogleTagManagerQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetGoogleTagManagerQuery, GetGoogleTagManagerQueryVariables>(GetGoogleTagManagerDocument, baseOptions);
        }
export type GetGoogleTagManagerQueryHookResult = ReturnType<typeof useGetGoogleTagManagerQuery>;
export type GetGoogleTagManagerLazyQueryHookResult = ReturnType<typeof useGetGoogleTagManagerLazyQuery>;
export type GetGoogleTagManagerQueryResult = ApolloReactCommon.QueryResult<GetGoogleTagManagerQuery, GetGoogleTagManagerQueryVariables>;
export const GetProductMattressOffersDocument = gql`
    query getProductMattressOffers($id: Int!) {
  getProductMattressOffers(productId: $id) {
    id
    name
    image
    url
...
/**
 * __useGetProductMattressOffersQuery__
 *
 * To run a query within a React component, call `useGetProductMattressOffersQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProductMattressOffersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProductMattressOffersQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetProductMattressOffersQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetProductMattressOffersQuery, GetProductMattressOffersQueryVariables>) {
        return ApolloReactHooks.useQuery<GetProductMattressOffersQuery, GetProductMattressOffersQueryVariables>(GetProductMattressOffersDocument, baseOptions);
      }
export function useGetProductMattressOffersLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetProductMattressOffersQuery, GetProductMattressOffersQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetProductMattressOffersQuery, GetProductMattressOffersQueryVariables>(GetProductMattressOffersDocument, baseOptions);
        }
export type GetProductMattressOffersQueryHookResult = ReturnType<typeof useGetProductMattressOffersQuery>;
export type GetProductMattressOffersLazyQueryHookResult = ReturnType<typeof useGetProductMattressOffersLazyQuery>;
export type GetProductMattressOffersQueryResult = ApolloReactCommon.QueryResult<GetProductMattressOffersQuery, GetProductMattressOffersQueryVariables>;
export const GetTopSearchesDocument = gql`
...
/**
 * __useGetTopSearchesQuery__
 *
 * To run a query within a React component, call `useGetTopSearchesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetTopSearchesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetTopSearchesQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetTopSearchesQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetTopSearchesQuery, GetTopSearchesQueryVariables>) {
        return ApolloReactHooks.useQuery<GetTopSearchesQuery, GetTopSearchesQueryVariables>(GetTopSearchesDocument, baseOptions);
      }
export function useGetTopSearchesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetTopSearchesQuery, GetTopSearchesQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetTopSearchesQuery, GetTopSearchesQueryVariables>(GetTopSearchesDocument, baseOptions);
        }
export type GetTopSearchesQueryHookResult = ReturnType<typeof useGetTopSearchesQuery>;
export type GetTopSearchesLazyQueryHookResult = ReturnType<typeof useGetTopSearchesLazyQuery>;
export type GetTopSearchesQueryResult = ApolloReactCommon.QueryResult<GetTopSearchesQuery, GetTopSearchesQueryVariables>;
export const GetTrustpilotBusinessReviewsDocument = gql`
    query getTrustpilotBusinessReviews {
  getTrustpilotBusinessReviews {
    ...TrustpilotBusinessReviewsResponse
  }
}
    ${TrustpilotBusinessReviewsResponseFragmentDoc}`;

/**
 * __useGetTrustpilotBusinessReviewsQuery__
 *
 * To run a query within a React component, call `useGetTrustpilotBusinessReviewsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetTrustpilotBusinessReviewsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetTrustpilotBusinessReviewsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetTrustpilotBusinessReviewsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetTrustpilotBusinessReviewsQuery, GetTrustpilotBusinessReviewsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetTrustpilotBusinessReviewsQuery, GetTrustpilotBusinessReviewsQueryVariables>(GetTrustpilotBusinessReviewsDocument, baseOptions);
      }
export function useGetTrustpilotBusinessReviewsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetTrustpilotBusinessReviewsQuery, GetTrustpilotBusinessReviewsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetTrustpilotBusinessReviewsQuery, GetTrustpilotBusinessReviewsQueryVariables>(GetTrustpilotBusinessReviewsDocument, baseOptions);
        }
export type GetTrustpilotBusinessReviewsQueryHookResult = ReturnType<typeof useGetTrustpilotBusinessReviewsQuery>;
export type GetTrustpilotBusinessReviewsLazyQueryHookResult = ReturnType<typeof useGetTrustpilotBusinessReviewsLazyQuery>;
export type GetTrustpilotBusinessReviewsQueryResult = ApolloReactCommon.QueryResult<GetTrustpilotBusinessReviewsQuery, GetTrustpilotBusinessReviewsQueryVariables>;
