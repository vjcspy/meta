  ...
  (builder) => {
    builder
      ...
      .addCase(productsGotData, (state, action) => {
        ...
        state.totals = action.payload?.totals || 0;
      ...
      .addCase(productsClearFiltersCustom, (state, action) => {
        state.filters = action.payload.filters;
        state.isUpdatingProducts = true;
        state.pageFilterInfo.currentPage = 1;
        state.products = [];
      ...
      .addCase(rangePriceFilterAction, (state, action) => {
        state.rangePriceFilter = action.payload.data;
      });
  }
);
