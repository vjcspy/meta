...
export const productsClearFilters = createAction<{}>(
...
export const productUpdatedUrlWhenChangeFilters = createAction<{}>(
  PRODUCTS_UPDATED_URL_WHEN_CHANGE_FILTERS,
  prefix
);
...
const PRODUCTS_CLEAR_FILTERS_CUSTOM = 'PRODUCTS_CLEAR_FILTERS_CUSTOM';
export const productsClearFiltersCustom = createAction<{
  filters: any[];
}>(PRODUCTS_CLEAR_FILTERS_CUSTOM, prefix);

const PRODUCT_SET_RANGE_FILTER_PRICE = 'PRODUCT_SET_RANGE_FILTER_PRICE';

export const rangePriceFilterAction = createAction<{
  data: { min: number; max: number };
}>(PRODUCT_SET_RANGE_FILTER_PRICE, prefix);
