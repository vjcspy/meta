...
const Sidebar = () => {
    ...
    const showDemo = useSelector(
        (state: IRootState) => state.themeConfig.themeDemo,
    );
    ...
    return (
        <div className={semidark ? 'dark' : ''}>
            <nav
                className={`sidebar fixed inset-y-0 z-50 h-full min-h-screen w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300${
                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight
                                    duration={300}
                                    height={currentMenu === 'home' ? 'auto' : 0}
                                >
                                ...
                                <li className="menu nav-item">
                                    ...
                                    >
                                        <ul className="sub-menu text-gray-500">
                                            ...
                                            <li>
                                                <Link href="/forms/switches">
                                                    {t('switches')}
                                                </Link>
                                            </li>
                                            <li>
                                                <Link href="/forms/wizards">
                                                    {t('wizards')}
                                                </Link>
                                            </li>
                                            <li>
