...
function TickAtPriceSummaryRender({ state }: InjectedProps) {
  const { tickSummary: summary, ticksLoading: isLoading, ticksError: error } = state;
  const netFlow = summary ? summary.totalBuy - summary.totalSell : 0;

  return (
    <DashboardWidget widgetId="w-tick-summary" title="Tick Summary" canClose canMove canResize>
      <div className="p-4">
        {error ? (
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div className="rounded-md border p-3">
              <div className="mb-1 text-xs text-muted-foreground">Total Buy</div>
            ...
            <div className="rounded-md border p-3">
              <div className="mb-1 text-xs text-muted-foreground">Total Sell</div>
            ...
            <div className="rounded-md border p-3">
              <div className="mb-1 text-xs text-muted-foreground">Shark Buy</div>
            ...
            <div className="rounded-md border p-3">
              <div className="mb-1 text-xs text-muted-foreground">Shark Sell</div>
            ...
            <div className="rounded-md border p-3">
              <div className="mb-1 text-xs text-muted-foreground">Sheep Buy</div>
            ...
            <div className="rounded-md border p-3">
              <div className="mb-1 text-xs text-muted-foreground">Sheep Sell</div>
            ...
            <div className="col-span-2 rounded-md border p-3">
              <div className="mb-1 text-xs text-muted-foreground">Net Flow (Buy − Sell)</div>
              <div
                className="text-lg font-bold"
                style={{
                  color:
                    netFlow >= 0 ? TICK_ACTION_COLORS[TickAction.BUY_SHARK] : TICK_ACTION_COLORS[TickAction.SELL_SHARK],
                }}
              >
                {netFlow >= 0 ? "+" : ""}
                {formatVol(netFlow)}
