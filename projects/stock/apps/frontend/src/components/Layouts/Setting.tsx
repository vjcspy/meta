  ...
  return (
    <div>
      ...
      <nav
        ...
        } fixed inset-y-0 z-[51] w-full max-w-[400px] bg-white p-4 shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 ltr:-right-[400px] rtl:-left-[400px] dark:bg-black`}
      >
        <button
          type="button"
          className="absolute inset-y-0 my-auto flex h-10 w-12 cursor-pointer items-center justify-center bg-primary text-white ltr:-left-12 ltr:rounded-l-full rtl:-right-12 rtl:rounded-r-full"
        ...
        <div className="perfect-scrollbar h-full overflow-y-auto overflow-x-hidden">
          ...
          <div className="mb-3 rounded-md border border-dashed border-white-light p-3 dark:border-[#1b2e4b]">
            ...
            <p className="text-xs text-white-dark">Show Demo</p>
            <div className="mt-3 flex gap-2">
              <button
                type="button"
                className={`${
                  themeConfig.themeDemo === '1'
                    ? 'btn-primary'
                    : 'btn-outline-primary'
                } btn flex-auto`}
                onClick={() =>
